...
#     }
#     # Notice: employee_dashboard.html (with the prefix)
#     return render(request, "employees/employee_dashboard.html", context)
...
#     # Pass BOTH membership and employee
...
#             return redirect("leave_list", org_id=employee.organization_id)
#         else:
#             # Print errors to terminal and flash to template
#             print("LeaveForm validation errors:", form.errors)
...
#     is_self = bool(employee.user_id and employee.user_id == request.user.id)
#     can_manage = permissions.can_manage_employees(membership)
...
#     # Permission check: Members can only see their own payslip; Admins/Supervisors see their scoped employees
#     if membership.role == "member" and employee.user_id != request.user.id:
...
#     # Parse date range & cycle month from query params
...
#     # Check for frozen historical SalaryRecord
